...
// PROD
var url2 = 'mongodb://' + (process.env.USERNAME || cred.username)  + ':' + (process.env.PASSWORD || cred.password) + (process.env.DATAB || cred.datab);
...
// PROD 
app.use(session({ secret: (process.env.SECRET || cred.secret) }))
